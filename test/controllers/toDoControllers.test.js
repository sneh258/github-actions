...
describe('ToDo Controllers', () => {
    ...
    it('should return error', async () => {
        jest.spyOn(getServices, 'getTasks').mockRejectedValue(new Error('Internal Server error!!'));
    ...
    it('should return error', async () => {
        jest.spyOn(getServices, 'getTasksById').mockRejectedValue(new Error('Internal Server error!!'));
    ...
    it('should return error', async () => {
        jest.spyOn(getServices, 'deleteTasks').mockRejectedValue(new Error('Internal Server error!!'));
    ...
    it('should return error', async () => {
        jest.spyOn(getServices, 'updateTasks').mockRejectedValue(new Error('Internal Server error!!'));
